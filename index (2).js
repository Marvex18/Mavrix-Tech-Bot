...
// FIXED: Correct store import for Baileys with multiple fallbacks

let makeInMemoryStore;

try {

    // Try importing from the store module directly

    const storeModule = require("@whiskeysockets/baileys/lib/store");

    makeInMemoryStore = storeModule.makeInMemoryStore;
    ...
    try {
        ...
        // Fallback to main module import

        const baileys = require("@whiskeysockets/baileys");

        makeInMemoryStore = baileys.makeInMemoryStore;

        console.log('✅ Store imported from @whiskeysockets/baileys main module');
...
async function startMavrixBot() {
    ...
    try {
        ...
        const MavrixBot = makeWASocket({
            ...
            syncFullHistory: false, // Set to false for better performance
        ...
        // FIXED: Use the proper store binding
        ...
        MavrixBot.ev.on('connection.update', async (s) => {
            ...
            if (connection == "open") {
                ...
                await MavrixBot.sendMessage(botNumber, {
                    ...
                    text: `🤖 Mavrix Bot Connected Successfully!\n\n⏰ Time: ${new Date().toLocaleString()}\n✅ Status: Online and Ready!\n\n✅ Developed by Mavrix Tech`,
                ...
                console.log(chalk.green(`${global.themeemoji || '•'} 🤖 Mavrix Bot Connected Successfully! ✅`))
